...
<a
    ...
    class="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50">
    ...
    <div class="divide-y divide-gray-100">
        ...
        @foreach($feeCycles as $cycle)
            ...
            @php
                $remaining = max(
                    0,
                    (float) $cycle->amount - (float) $cycle->paid_amount
                );
            @endphp
